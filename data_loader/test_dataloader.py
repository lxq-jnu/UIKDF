...
class TestdataLoader(data.Dataset):#加载数据集
    def __init__(self, data_dir, transform=to_tensor):
        super().__init__()
        dirname = os.listdir(data_dir)  # 获得 LLVIP 数据集的子目录
    ...
    def __getitem__(self, index):
        ...
        return vis_image, vis_y_image, vis_cb_image, vis_cr_image, inf_image,inf3_image, name
